  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "creature-cosmic": {
          "0%": { transform: "translateX(0) translateY(0) rotate(0deg) scaleX(1)", filter: "brightness(1) drop-shadow(0 0 18px #aa66ff) drop-shadow(0 0 6px #00eeff)" },
          "12%": { transform: "translateX(3px) translateY(-1px) rotate(0.8deg) scaleX(1.02)", filter: "brightness(1.5) drop-shadow(0 0 30px #cc88ff) drop-shadow(0 0 10px #00eeff)" },
          "25%": { transform: "translateX(4px) translateY(1px) rotate(1.5deg) scaleX(0.99)", filter: "brightness(1.0) drop-shadow(0 0 15px #aa66ff) drop-shadow(0 0 5px #00eeff)" },
          "37%": { transform: "translateX(2px) translateY(2px) rotate(0.5deg) scaleX(1.03)", filter: "brightness(1.8) drop-shadow(0 0 38px #6644cc) drop-shadow(0 0 14px #00eeff)" },
          "50%": { transform: "translateX(0px) translateY(0px) rotate(-0.5deg) scaleX(1.0)", filter: "brightness(1.1) drop-shadow(0 0 18px #aa66ff) drop-shadow(0 0 6px #00eeff)" },
          "62%": { transform: "translateX(-3px) translateY(-1px) rotate(-1.5deg) scaleX(1.02)", filter: "brightness(1.7) drop-shadow(0 0 35px #cc88ff) drop-shadow(0 0 12px #00eeff)" },
          "75%": { transform: "translateX(-4px) translateY(1px) rotate(-0.8deg) scaleX(0.99)", filter: "brightness(1.0) drop-shadow(0 0 15px #aa66ff) drop-shadow(0 0 5px #00eeff)" },
          "87%": { transform: "translateX(-2px) translateY(-1px) rotate(0deg) scaleX(1.03)", filter: "brightness(1.6) drop-shadow(0 0 32px #6644cc) drop-shadow(0 0 10px #00eeff)" },
          "100%": { transform: "translateX(0) translateY(0) rotate(0deg) scaleX(1)", filter: "brightness(1) drop-shadow(0 0 18px #aa66ff) drop-shadow(0 0 6px #00eeff)" },
        },
      },
      },
      animation: {
