  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "creature-cosmic": {
          "0%": { transform: "translateX(0) translateY(0) rotate(0deg) scale(1)", filter: "brightness(1) drop-shadow(0 0 18px #aa66ff) drop-shadow(0 0 6px #00eeff)" },
          "8%": { transform: "translateX(2px) translateY(-1px) rotate(1deg) scale(1.02)", filter: "brightness(1.4) drop-shadow(0 0 28px #cc88ff) drop-shadow(0 0 10px #00eeff)" },
          "16%": { transform: "translateX(3px) translateY(0px) rotate(2deg) scale(1.0)", filter: "brightness(1.0) drop-shadow(0 0 15px #aa66ff) drop-shadow(0 0 5px #00eeff)" },
          "25%": { transform: "translateX(2px) translateY(1px) rotate(1deg) scale(1.04)", filter: "brightness(1.7) drop-shadow(0 0 35px #6644cc) drop-shadow(0 0 12px #00eeff)" },
          "33%": { transform: "translateX(0px) translateY(2px) rotate(0deg) scale(1.01)", filter: "brightness(1.1) drop-shadow(0 0 18px #aa66ff) drop-shadow(0 0 6px #00eeff)" },
          "42%": { transform: "translateX(-2px) translateY(1px) rotate(-1deg) scale(1.05)", filter: "brightness(1.8) drop-shadow(0 0 38px #cc88ff) drop-shadow(0 0 14px #00eeff)" },
          "50%": { transform: "translateX(-3px) translateY(0px) rotate(-2deg) scale(1.0)", filter: "brightness(1.0) drop-shadow(0 0 15px #aa66ff) drop-shadow(0 0 5px #00eeff)" },
          "58%": { transform: "translateX(-2px) translateY(-1px) rotate(-1deg) scale(1.03)", filter: "brightness(1.5) drop-shadow(0 0 30px #6644cc) drop-shadow(0 0 10px #00eeff)" },
          "67%": { transform: "translateX(0px) translateY(-2px) rotate(0deg) scale(1.06)", filter: "brightness(2.0) drop-shadow(0 0 42px #cc88ff) drop-shadow(0 0 16px #00eeff)" },
          "75%": { transform: "translateX(1px) translateY(-1px) rotate(0.5deg) scale(1.01)", filter: "brightness(1.1) drop-shadow(0 0 18px #aa66ff) drop-shadow(0 0 6px #00eeff)" },
          "83%": { transform: "translateX(2px) translateY(0px) rotate(1deg) scale(1.04)", filter: "brightness(1.6) drop-shadow(0 0 32px #6644cc) drop-shadow(0 0 12px #00eeff)" },
          "92%": { transform: "translateX(1px) translateY(1px) rotate(0.5deg) scale(1.02)", filter: "brightness(1.3) drop-shadow(0 0 25px #aa66ff) drop-shadow(0 0 8px #00eeff)" },
          "100%": { transform: "translateX(0) translateY(0) rotate(0deg) scale(1)", filter: "brightness(1) drop-shadow(0 0 18px #aa66ff) drop-shadow(0 0 6px #00eeff)" },
        },
      },
      },
      animation: {
