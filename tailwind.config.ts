  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "creature-cosmic": {
          "0%": { transform: "translateX(0) translateY(0) rotate(0deg) scale(1)", filter: "brightness(1) drop-shadow(0 0 15px #aa66ff)" },
          "12%": { transform: "translateX(1px) translateY(-1px) rotate(0.5deg) scale(1.02)", filter: "brightness(1.3) drop-shadow(0 0 22px #cc88ff)" },
          "25%": { transform: "translateX(2px) translateY(0px) rotate(1deg) scale(1.0)", filter: "brightness(1.0) drop-shadow(0 0 18px #aa66ff)" },
          "37%": { transform: "translateX(1px) translateY(1px) rotate(-0.5deg) scale(1.03)", filter: "brightness(1.5) drop-shadow(0 0 28px #6644cc)" },
          "50%": { transform: "translateX(-1px) translateY(0px) rotate(-1deg) scale(1.01)", filter: "brightness(1.1) drop-shadow(0 0 15px #aa66ff)" },
          "62%": { transform: "translateX(-2px) translateY(-1px) rotate(0deg) scale(1.04)", filter: "brightness(1.6) drop-shadow(0 0 30px #cc88ff)" },
          "75%": { transform: "translateX(-1px) translateY(1px) rotate(0.5deg) scale(1.0)", filter: "brightness(1.0) drop-shadow(0 0 15px #aa66ff)" },
          "87%": { transform: "translateX(0px) translateY(-1px) rotate(-0.5deg) scale(1.03)", filter: "brightness(1.4) drop-shadow(0 0 25px #6644cc)" },
          "100%": { transform: "translateX(0) translateY(0) rotate(0deg) scale(1)", filter: "brightness(1) drop-shadow(0 0 15px #aa66ff)" },
        },
      },
      },
      animation: {
        ...
        "creature-cosmic": "creature-cosmic 6s ease-in-out infinite",
      },
    },
  },
