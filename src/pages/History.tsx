    ...
    if (minutes >= 60) {
      ...
      return (
        <span className="inline-flex items-baseline">
          <span>{hours}</span>
          <span className="text-3xl md:text-4xl ml-1 text-primary/50 font-medium">h</span>
          {mins > 0 && (
            <>
              <span className="ml-2">{mins}</span>
              <span className="text-3xl md:text-4xl ml-1 text-primary/50 font-medium">m</span>
            </>
          )}
        </span>
      );
            ...
            <div className="bg-white/5 backdrop-blur-md rounded-3xl p-5 border border-white/10">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-3xl font-bold font-mono tracking-tight text-primary inline-flex items-baseline">
                  ...
                  <span className="text-lg ml-0.5 text-primary/50 font-medium">m</span>
                </p>
              </div>
            </div>
          </div>
