...
import { Anchor, Settings, Mail, Lock, User, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        ...
        <div className="absolute w-60 h-60 rounded-full border border-primary/15 animate-ping" style={{ animationDuration: '2.5s', animationDelay: '0.5s' }} />
        <div className="absolute w-40 h-40 rounded-full border border-primary/20 animate-ping" style={{ animationDuration: '2s', animationDelay: '1s' }} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md space-y-8">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="relative flex items-center justify-center w-24 h-24 animate-float">
            <div className="absolute inset-0 flex items-center justify-center animate-[spin_10s_linear_infinite]">
              <Settings 
                strokeWidth={0.5} 
                className="w-full h-full text-primary/40 drop-shadow-[0_0_15px_hsl(var(--primary)/0.3)]" 
              />
            </div>
            <div className="absolute inset-6 border border-primary/30 rounded-full drop-shadow-[0_0_10px_hsl(var(--primary)/0.4)]" />
            <Anchor className="relative z-20 w-10 h-10 text-primary drop-shadow-[0_0_30px_hsl(var(--primary))]" />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            {isSignUp && (
              <div className="space-y-2">
                <Label htmlFor="displayName" className="text-muted-foreground font-mono text-xs tracking-wider">
                  CALLSIGN (OPTIONAL)
                </Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="email" className="text-muted-foreground font-mono text-xs tracking-wider">
              ...
              <div className="relative">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="captain@deepdive.io"
                  value={email}
            ...
            <div className="space-y-2">
              <Label htmlFor="password" className="text-muted-foreground font-mono text-xs tracking-wider">
          ...
          <Button
            ...
            className="w-full h-12 bg-primary/20 border-2 border-primary text-primary font-robotic uppercase tracking-[0.2em] hover:bg-primary hover:text-black transition-all duration-300 hover:shadow-[0_0_30px_hsl(var(--primary)/0.6)]"
          >
            {isSubmitting ? 'PROCESSING...' : isSignUp ? 'REGISTER CREW' : 'INITIALIZE DIVE'}
          </Button>
        </form>
        ...
        <Button
          ...
          className="w-full h-12 bg-transparent border-2 border-muted-foreground/30 text-muted-foreground font-robotic uppercase tracking-wider hover:border-primary/50 hover:text-primary transition-all duration-300"
        >
        ...
        <p className="text-center text-muted-foreground text-sm font-mono">
          {isSignUp ? 'Already have credentials?' : 'New to the fleet?'}{' '}
          <button
            type="button"
            onClick={() => {
